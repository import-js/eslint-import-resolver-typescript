...
<a href="https://star-history.dera.page/#import-js/eslint-import-resolver-typescript&type=Date">
 <picture>
   <source media="(prefers-color-scheme: dark)" srcset="https://star-history.dera.page/svg?repos=import-js/eslint-import-resolver-typescript&type=Date&theme=dark" />
   <source media="(prefers-color-scheme: light)" srcset="https://star-history.dera.page/svg?repos=import-js/eslint-import-resolver-typescript&type=Date" />
   <img alt="Star History Chart" src="https://star-history.dera.page/svg?repos=import-js/eslint-import-resolver-typescript&type=Date" />
 </picture>
</a>
